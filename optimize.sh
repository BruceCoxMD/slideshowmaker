#!/bin/bash
# https://gist.githubusercontent.com/lgiraudel/6065155/raw/24f667559eee61dd00a99a9940e06b46a125d3ec/optimize.sh
# blogpost http://hugogiraudel.com/2013/07/29/optimizing-with-bash/
